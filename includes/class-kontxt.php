...
class Kontxt {
	...
	public function __construct() {
		...
		$this->api_host         = 'http://api.kontxt.cloud/wp-json/kontxt/v1/analyze'; // 'http://api.kontxt.cloud/wp-json/kontxt/v1/analyze';
		$this->api_host_only    = 'api.kontxt.cloud'; // api.kontxt.cloud
